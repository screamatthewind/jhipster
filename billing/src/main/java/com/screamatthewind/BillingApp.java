...
import com.screamatthewind.config.ApplicationProperties;
...
public class BillingApp implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Template template = templateRepository.save(new Template("Template 1"));
		
		agentRepository.save(new Agent("123", "Agent 1", "Address 1", "Address 2", "City", "State", "Zip", "Phone", "Email", "Username", "Password", true, 1000.00f, template));
