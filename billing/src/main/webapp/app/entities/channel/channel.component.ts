...
export class ChannelComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.channelService.query({
            ...
            (res: HttpResponse<Channel[]>) => this.onSuccess(res.body, res.headers),
    ...
    registerChangeInChannels() {
        this.eventSubscriber = this.eventManager.subscribe('channelListModification', (response) => this.reset());
    }
